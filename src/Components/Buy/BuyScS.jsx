    ...
    <>
      <div id="buy">
        ...
        <section className="bcont">
          <div className="container">
            <h3 className="text-center wow bounceIn">Subscribers/Followers Available Accounts</h3>
                ...
                <div key={pkg.id} className="col-lg-4 col-md-8 col-sm-9">
                  <div className="single-pricing pborder active text-center mt-30">
                    ...
                    <div className="pricing-body">
                     {pkg.price? <div className="pricing-text">
                        <span className="price">{pkg.price}</span>
                      </div>: <div className="pricing-text">
                        <span style={{color:"red"}}>Contact below for Pricing</span>
                      </div>}
